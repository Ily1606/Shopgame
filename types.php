...
$res = mysqli_query($conn, "SELECT * FROM table_types WHERE id = $game_type");
            ...
            <div class="card-body">
                ...
                <div class="card-body">
                    <div id="product_list" class="row">
                        <?php
                        $res = mysqli_query($conn, "SELECT * FROM table_product WHERE `type` = '$game_type' AND `status` = 1 ORDER BY create_time DESC");
                        if (mysqli_num_rows($res)) {
