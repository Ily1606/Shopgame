...
$data_required = array("name", "des", "money", "number", "game_types","type", "from_sale", "end_sale", "money_sale", "poster", "banner");
...
if (mysqli_query($conn, "INSERT INTO table_product (`name`,`descryption`,`money`,`user_id`,`type_game`,`poster`,`banner`,`from_sale`,`end_sale`,`money_sale`,`enable_sale`,`type`) VALUES ('$name','$des','$money','$id','$game_types','$poster','$banner','$from_sale','$end_sale','$money_sale','$enable_sale','$type')")) {
