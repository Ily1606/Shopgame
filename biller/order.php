...
$res = mysqli_query($conn, "SELECT table_biller.*, table_product.poster, table_product.name FROM table_biller INNER JOIN table_product ON table_biller.id_product = table_product.id WHERE table_product.user_id = $id ORDER BY table_biller.create_time DESC");
?>
<html>
    ...
    <div class="container">
        <div class="row">
            <div class="card cover_page mt-2">
                <div class="card-body">
                    <p class="h3 mb-2">Các đơn đặt hàng từ kênh của bạn</p>
                    <div class="row">
                        <?php
                        ...
                        ?>
                                <div class="col-lg-3 col-sm-6 mt-2"><a class="col-sm-12 product_item d-block" href="/biller/biller.php?id=<?php echo $row["id"] ?>">
                                        <div class="ribbon">
                                            <?php if($row["payed"] == 1) echo "Đã thanh toán"; else echo "Chưa thanh toán"; ?>
                                        </div>
